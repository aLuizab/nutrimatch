...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  PAYOUT_MARKED_SENT: 'Declarou que a transferência de um repasse saiu',
  PAYOUT_MARKED_PAID: 'Concluiu um repasse, com comprovante anexado',
...
const ACTION_TONE: Record<AuditAction, string> = {
  ...
  PAYOUT_MARKED_SENT: 'bg-blue-50 text-blue-700 border-blue-100',
